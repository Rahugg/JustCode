...
func request_PortService_Create_0(ctx context.Context, marshaler runtime.Marshaler, client PortServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterPortServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PortServiceServer) error {
	...
	mux.Handle("POST", pattern_PortService_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterPortServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PortServiceClient) error {
	...
	mux.Handle("POST", pattern_PortService_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/port.PortService/Create", runtime.WithHTTPPathPattern("/port.PortService/Create"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PortService_Create_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		...
		forward_PortService_Create_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_PortService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"port.PortService", "Create"}, ""))
)

var (
	forward_PortService_Create_0 = runtime.ForwardResponseMessage
)
